  ...
  return (
    <section className="about">
      ...
      <p>
        ...
        <strong> computer science</strong> and a passion for creating efficient,
        scalable solutions. Specializing in <strong>web development</strong>, 
        I have successfully delivered multiple
